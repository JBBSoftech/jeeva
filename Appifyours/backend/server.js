...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/jeeva__app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '695b5f50c356b1a2bbc81adc',
...
app.listen(PORT, () => {
  ...
  console.log(`Jeeva  Backend Server running on port ${PORT}`);
